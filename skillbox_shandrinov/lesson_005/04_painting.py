...
drawing_house.house(house_height, house_width, x_screen_shift, y_screen_shift, roof_color, lines_color)
drawing_house.ground(screen_width=screen_width, y_screen_shift=y_screen_shift, color=ground_color)
drawing_house.window(house_height, house_width, x_screen_shift, y_screen_shift)
drawing_house.smile(x=x_screen_shift + house_width / 2, y=y_screen_shift + house_height / 2)

# рисуем дерево
shift_from_house = 300
root_point = sd.get_point(house_width + x_screen_shift + shift_from_house, y_screen_shift)
